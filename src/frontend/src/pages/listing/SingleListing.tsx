...
import { Bookmark, ChevronDown, ChevronRight, Mail, Phone, ScrollText, StarIcon, User } from 'lucide-react';
...
const SingleListing = () => {
    ...
    const [showJobListingDetails, setShowJobListingDetails] = useState(true);
            ...
            <div className="grid gap-y-5 lg:gap-x-16 lg:grid-cols-[1fr_24rem]">
                <div className="left px-3 lg:px-4 py-4 lg:py-6 rounded-lg shadow-[0_0px_5px_rgba(9,11,12,.4)] w-full">
                    <div className="flex justify-between mb-4 md:px-4 text-sm">
                        ...
                        <div className="flex gap-1 text-white/70 hover:text-gray-300">
                    ...
                    <div>
                        <div className="flex justify-between items-center mt-4 text-white/70 cursor-pointer">
                            <div className="text-white text-lg">Overview</div>
                        ...
                        <div className='flex mt-5'>
                            <div className="description-toggle cursor-pointer text-[#AFDE74]" onClick={() => setDescriptionClose((current) => !current)} >
