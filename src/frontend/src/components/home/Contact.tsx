                ...
                <div className="lg:w-96 w-auto h-auto bg-[#101218]/80 shadow-xl lg:p-6 p-4 rounded-[4px]">
                  <div className="flex justify-center mb-6">
                    <div className="brand">
                            ...
                            <span className="brand-text text-3xl font-bold text-white">HandiMan</span>
                        </div>
                    </div>
