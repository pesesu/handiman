...
const FeaturedServices = () => {
  ...
  return (
    <div className='featured-servicess py-12 px-3 md:px-5 !bg-[#101218]'>
        <div className="flex items-center justify-between mb-10">
          <div className="text-xl text-white text-left font-semibold h-font">Featured Seeeervices</div>
          <Button className='text-xs text-white hover:text-[#223841] bg-transparent hover:bg-[#afde74] border-[#afde74] rounded-lg px-3 font-semibold' variant="outline">View All</Button>
        </div>
